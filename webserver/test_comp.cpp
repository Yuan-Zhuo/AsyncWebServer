...
int main() {
...

  {
    boost::multi_index_container<
        A, indexed_by<ordered_unique<tag<tags::x_asc>, member<A, int, &A::x> >,
                      ordered_unique<tag<tags::y_asc>, member<A, int, &A::y> >,
                      hashed_unique<tag<tags::unordered>, identity<A>,
                                    std::hash<A> > > >
        mic;
...

  {
    ...
    benchmark(
        [&]() {
          if (it == x_asc.end()) it = x_asc.begin();
          x += it->x;
          ++it;
        },
        "std::set walk");
